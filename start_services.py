...
# -*- coding: utf-8 -*-
"""
Simple script to start both FastAPI backend and provide instructions for Streamlit.
"""
...
def start_services():
    ...
    if not venv_python.exists():
        ...
        print("[INFO] Then: .\\venv\\Scripts\\python.exe -m pip install -r requirements.txt")
        return False
    ...
    try:
        print("   Command: .\\venv\\Scripts\\python.exe -m uvicorn app.main:app --reload")
    ...
    print("   .\\venv\\Scripts\\python.exe -m streamlit run streamlit_app.py")
